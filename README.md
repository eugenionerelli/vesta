...
- Generazione in locale sul Mac, su GPU cloud gratuita, oppure in modalità Premium con modelli a pagamento (OpenAI gpt-image-1 o Google gemini-2.5-flash-image) inserendo la propria chiave API dal Profilo.
